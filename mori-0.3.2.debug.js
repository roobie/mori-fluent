...
cljs.core.nil_iter = function nil_iter() {
  "undefined" === typeof cljs.core.t7475 && (cljs.core.t7475 = function(b, c) {
    this.nil_iter = b;
    this.meta7476 = c;
    this.cljs$lang$protocol_mask$partition1$ = 0;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
  }, cljs.core.t7475.prototype.hasNext = function() {
    return!1;
  }, cljs.core.t7475.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t7475.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t7475.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
    return this.meta7476;
  }, cljs.core.t7475.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
    return new cljs.core.t7475(this.nil_iter, c);
  }, cljs.core.t7475.cljs$lang$type = !0, cljs.core.t7475.cljs$lang$ctorStr = "cljs.core/t7475", cljs.core.t7475.cljs$lang$ctorPrWriter = function(b, c, d) {
    return cljs.core._write(c, "cljs.core/t7475");
  }, cljs.core.__GT_t7475 = function(b, c) {
    return new cljs.core.t7475(b, c);
  });
  return new cljs.core.t7475(nil_iter, new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null, "end-column", "end-column", 1425389514), 54, new cljs.core.Keyword(null, "end-line", "end-line", 1837326455), 2998, new cljs.core.Keyword(null, "column", "column", 2078222095), 3, new cljs.core.Keyword(null, "line", "line", 212345235), 2994, new cljs.core.Keyword(null, "file", "file", -1269645878), "/home/bjorn/devel/mori/out-mori-adv/cljs/core.cljs"], null));
};
...
goog.exportSymbol("mori.mutable.conj.f0", cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$0);
goog.exportSymbol("mori.mutable.conj.f1", cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$1);
goog.exportSymbol("mori.mutable.conj.f2", cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2);
goog.exportSymbol("mori.mutable.conj.fn", cljs.core.conj_BANG_.cljs$core$IFn$_invoke$variadic);
mori.mutable.assoc = cljs.core.assoc_BANG_;
goog.exportSymbol("mori.mutable.assoc", mori.mutable.assoc);
goog.exportSymbol("mori.mutable.assoc.f3", cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3);
goog.exportSymbol("mori.mutable.assoc.fn", cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$variadic);
mori.mutable.dissoc = cljs.core.dissoc_BANG_;
goog.exportSymbol("mori.mutable.dissoc", mori.mutable.dissoc);
goog.exportSymbol("mori.mutable.dissoc.f2", cljs.core.dissoc_BANG_.cljs$core$IFn$_invoke$arity$2);
goog.exportSymbol("mori.mutable.dissoc.fn", cljs.core.dissoc_BANG_.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.mutable.disj.f2", cljs.core.disj_BANG_.cljs$core$IFn$_invoke$arity$2);
goog.exportSymbol("mori.mutable.disj.fn", cljs.core.disj_BANG_.cljs$core$IFn$_invoke$variadic);
var clojure = {set:{}};
...
goog.exportSymbol("mori.apply.fn", cljs.core.apply.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.conj.fn", cljs.core.conj.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.assoc.fn", cljs.core.assoc.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.dissoc.fn", cljs.core.dissoc.cljs$core$IFn$_invoke$variadic);
mori.getIn = cljs.core.get_in;
goog.exportSymbol("mori.getIn", mori.getIn);
...
mori.updateIn = cljs.core.update_in;
goog.exportSymbol("mori.updateIn", mori.updateIn);
...
goog.exportSymbol("mori.updateIn.fn", cljs.core.update_in.cljs$core$IFn$_invoke$variadic);
mori.assocIn = cljs.core.assoc_in;
goog.exportSymbol("mori.assocIn", mori.assocIn);
...
goog.exportSymbol("mori.disj.fn", cljs.core.disj.cljs$core$IFn$_invoke$variadic);
...
mori.hasKey = cljs.core.contains_QMARK_;
goog.exportSymbol("mori.hasKey", mori.hasKey);
mori.isEmpty = cljs.core.empty_QMARK_;
goog.exportSymbol("mori.isEmpty", mori.isEmpty);
...
mori.takeNth = cljs.core.take_nth;
goog.exportSymbol("mori.takeNth", mori.takeNth);
...
mori.partitionAll = cljs.core.partition_all;
goog.exportSymbol("mori.partitionAll", mori.partitionAll);
...
mori.partitionBy = cljs.core.partition_by;
goog.exportSymbol("mori.partitionBy", mori.partitionBy);
...
mori.mergeWith = cljs.core.merge_with;
goog.exportSymbol("mori.mergeWith", mori.mergeWith);
...
mori.takeWhile = cljs.core.take_while;
goog.exportSymbol("mori.takeWhile", mori.takeWhile);
...
mori.dropWhile = cljs.core.drop_while;
goog.exportSymbol("mori.dropWhile", mori.dropWhile);
...
mori.groupBy = cljs.core.group_by;
goog.exportSymbol("mori.groupBy", mori.groupBy);
...
goog.exportSymbol("mori.interleave.fn", cljs.core.interleave.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.concat.fn", cljs.core.concat.cljs$core$IFn$_invoke$variadic);
...
mori.lazySeq = function(a) {
  return new cljs.core.LazySeq(null, a, null, null);
};
goog.exportSymbol("mori.lazySeq", mori.lazySeq);
mori.keys = cljs.core.keys;
goog.exportSymbol("mori.keys", mori.keys);
mori.selectKeys = cljs.core.select_keys;
goog.exportSymbol("mori.selectKeys", mori.selectKeys);
mori.vals = cljs.core.vals;
goog.exportSymbol("mori.vals", mori.vals);
mori.primSeq = cljs.core.prim_seq;
goog.exportSymbol("mori.primSeq", mori.primSeq);
...
goog.exportSymbol("mori.map.fn", cljs.core.map.cljs$core$IFn$_invoke$variadic);
mori.mapIndexed = cljs.core.map_indexed;
goog.exportSymbol("mori.mapIndexed", mori.mapIndexed);
...
goog.exportSymbol("mori.mapcat.fn", cljs.core.mapcat.cljs$core$IFn$_invoke$variadic);
...
mori.reduceKV = cljs.core.reduce_kv;
goog.exportSymbol("mori.reduceKV", mori.reduceKV);
...
mori.keepIndexed = cljs.core.keep_indexed;
goog.exportSymbol("mori.keepIndexed", mori.keepIndexed);
...
goog.exportSymbol("mori.equals.fn", cljs.core._EQ_.cljs$core$IFn$_invoke$variadic);
...
mori.sortBy = cljs.core.sort_by;
goog.exportSymbol("mori.sortBy", mori.sortBy);
...
mori.intoArray = cljs.core.into_array;
goog.exportSymbol("mori.intoArray", mori.intoArray);
...
mori.eduction = cljs.core.eduction;
goog.exportSymbol("mori.eduction", mori.eduction);
...
goog.exportSymbol("mori.sequence.fn", cljs.core.sequence.cljs$core$IFn$_invoke$variadic);
mori.completing = cljs.core.completing;
goog.exportSymbol("mori.completing", mori.completing);
...
mori.hashMap = cljs.core.array_map;
goog.exportSymbol("mori.hashMap", mori.hashMap);
mori.set = cljs.core.set;
goog.exportSymbol("mori.set", mori.set);
mori.sortedSet = cljs.core.sorted_set;
goog.exportSymbol("mori.sortedSet", mori.sortedSet);
mori.sortedSetBy = cljs.core.sorted_set_by;
goog.exportSymbol("mori.sortedSetBy", mori.sortedSetBy);
mori.sortedMap = cljs.core.sorted_map;
goog.exportSymbol("mori.sortedMap", mori.sortedMap);
mori.sortedMapBy = cljs.core.sorted_map_by;
goog.exportSymbol("mori.sortedMapBy", mori.sortedMapBy);
mori.queue = function() {
  var a = function(a) {
...
mori.isList = cljs.core.list_QMARK_;
goog.exportSymbol("mori.isList", mori.isList);
mori.isSeq = cljs.core.seq_QMARK_;
goog.exportSymbol("mori.isSeq", mori.isSeq);
mori.isVector = cljs.core.vector_QMARK_;
goog.exportSymbol("mori.isVector", mori.isVector);
mori.isMap = cljs.core.map_QMARK_;
goog.exportSymbol("mori.isMap", mori.isMap);
mori.isSet = cljs.core.set_QMARK_;
goog.exportSymbol("mori.isSet", mori.isSet);
mori.isKeyword = cljs.core.keyword_QMARK_;
goog.exportSymbol("mori.isKeyword", mori.isKeyword);
mori.isSymbol = cljs.core.symbol_QMARK_;
goog.exportSymbol("mori.isSymbol", mori.isSymbol);
mori.isCollection = cljs.core.coll_QMARK_;
goog.exportSymbol("mori.isCollection", mori.isCollection);
mori.isSequential = cljs.core.sequential_QMARK_;
goog.exportSymbol("mori.isSequential", mori.isSequential);
mori.isAssociative = cljs.core.associative_QMARK_;
goog.exportSymbol("mori.isAssociative", mori.isAssociative);
mori.isCounted = cljs.core.counted_QMARK_;
goog.exportSymbol("mori.isCounted", mori.isCounted);
mori.isIndexed = cljs.core.indexed_QMARK_;
goog.exportSymbol("mori.isIndexed", mori.isIndexed);
mori.isReduceable = cljs.core.reduceable_QMARK_;
goog.exportSymbol("mori.isReduceable", mori.isReduceable);
mori.isSeqable = cljs.core.seqable_QMARK_;
goog.exportSymbol("mori.isSeqable", mori.isSeqable);
mori.isReversible = cljs.core.reversible_QMARK_;
goog.exportSymbol("mori.isReversible", mori.isReversible);
...
goog.exportSymbol("mori.union.fn", clojure.set.union.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.intersection.fn", clojure.set.intersection.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.difference.fn", clojure.set.difference.cljs$core$IFn$_invoke$variadic);
...
mori.mapInvert = clojure.set.map_invert;
goog.exportSymbol("mori.mapInvert", mori.mapInvert);
mori.rename = clojure.set.rename;
goog.exportSymbol("mori.rename", mori.rename);
mori.renameKeys = clojure.set.rename_keys;
goog.exportSymbol("mori.renameKeys", mori.renameKeys);
mori.isSubset = clojure.set.subset_QMARK_;
goog.exportSymbol("mori.isSubset", mori.isSubset);
mori.isSuperset = clojure.set.superset_QMARK_;
goog.exportSymbol("mori.isSuperset", mori.isSuperset);
mori.notEquals = cljs.core.not_EQ_;
goog.exportSymbol("mori.notEquals", mori.notEquals);
...
goog.exportSymbol("mori.notEquals.fn", cljs.core.not_EQ_.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.gt.fn", cljs.core._GT_.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.gte.fn", cljs.core._GT__EQ_.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.lt.fn", cljs.core._LT_.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.lte.fn", cljs.core._LT__EQ_.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.partial.fn", cljs.core.partial.cljs$core$IFn$_invoke$variadic);
...
goog.exportSymbol("mori.comp.fn", cljs.core.comp.cljs$core$IFn$_invoke$variadic);
...
mori.juxt = function() {
  var a = function(a) {
    return function() {
      var b = function(b) {
        return mori.intoArray.call(null, mori.map.call(null, function(a) {
...
mori.knit = function() {
  var a = function(a) {
    return function(b) {
      return mori.intoArray.call(null, mori.map.call(null, function(a, b) {
...
goog.exportSymbol("mori.sum.fn", cljs.core._PLUS_.cljs$core$IFn$_invoke$variadic);
mori.inc = cljs.core.inc;
goog.exportSymbol("mori.inc", mori.inc);
mori.dec = cljs.core.dec;
goog.exportSymbol("mori.dec", mori.dec);
mori.isEven = cljs.core.even_QMARK_;
goog.exportSymbol("mori.isEven", mori.isEven);
mori.isOdd = cljs.core.odd_QMARK_;
goog.exportSymbol("mori.isOdd", mori.isOdd);
...
mori.toJs = cljs.core.clj__GT_js;
goog.exportSymbol("mori.toJs", mori.toJs);
mori.toClj = function() {
  var a = null, b = function(a) {
...
goog.exportSymbol("mori.toClj", mori.toClj);
...
mori.withMeta = cljs.core.with_meta;
goog.exportSymbol("mori.withMeta", mori.withMeta);
mori.varyMeta = cljs.core.vary_meta;
goog.exportSymbol("mori.varyMeta", mori.varyMeta);
...
goog.exportSymbol("mori.varyMeta.fn", cljs.core.vary_meta.cljs$core$IFn$_invoke$variadic);
mori.alterMeta = cljs.core.alter_meta_BANG_;
goog.exportSymbol("mori.alterMeta", mori.alterMeta);
mori.resetMeta = cljs.core.reset_meta_BANG_;
goog.exportSymbol("mori.resetMeta", mori.resetMeta);
